...
public function archiverIntervention($numSal, $numFam, $hDeb, $dateDeb, $idPresta, $idADH, $jour, $hFin)
{
    ...
    */ 
    public function listeEntretiensGlobal($num){
        $req="SELECT intervenants.idSalarie_Intervenants, entretiens.numSalarie_Intervenants, titre_Candidats, nom_Candidats, prenom_Candidats, GROUP_CONCAT(DATE_FORMAT(`date`, '%d/%m/%Y') ORDER BY `date` DESC SEPARATOR ', ') AS dates, commentaire FROM candidats
        JOIN intervenants
